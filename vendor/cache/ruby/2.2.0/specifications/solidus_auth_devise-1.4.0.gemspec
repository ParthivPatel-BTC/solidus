# -*- encoding: utf-8 -*-
# stub: solidus_auth_devise 1.4.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<solidus_core>, ["< 2", ">= 1.0.6"])
      ...
      s.add_development_dependency(%q<solidus_backend>, ["< 2", ">= 1.0.6"])
      s.add_development_dependency(%q<solidus_frontend>, ["< 2", ">= 1.0.6"])
      ...
      s.add_dependency(%q<solidus_core>, ["< 2", ">= 1.0.6"])
      s.add_dependency(%q<devise>, ["~> 3.5.1"])
      s.add_dependency(%q<devise-encryptable>, ["= 0.1.2"])
      s.add_dependency(%q<deface>, ["~> 1.0.0"])
      s.add_dependency(%q<json>, [">= 0"])
      s.add_dependency(%q<multi_json>, [">= 0"])
      s.add_dependency(%q<solidus_backend>, ["< 2", ">= 1.0.6"])
      s.add_dependency(%q<solidus_frontend>, ["< 2", ">= 1.0.6"])
